...
.bottle:after{
	...
	margin-left:-8px;
	border-radius:4px;
	-webkit-animation:show-cap 2500ms linear infinite;
...
@-webkit-keyframes move{
	...
	48%{-webkit-transform:translateX(144px) translateY(0);transform:translateX(144px) translateY(0);}
	50%{
		-webkit-transform:translateX(150px) translateY(-10px);
		        transform:translateX(150px) translateY(-10px);
	}
	52%{-webkit-transform:translateX(156px) translateY(0);transform:translateX(156px) translateY(0);}
	75%{
		opacity:1;
...
@-webkit-keyframes move-cap{
	...
	45%{opacity:1}
	48%{-webkit-transform:translate(144px, 0);transform:translate(144px, 0)}
	50%{
...
@-webkit-keyframes lock-cap{
	0%,45%,48%,100%{opacity:0;-webkit-transform:translateY(-10px);transform:translateY(-10px)}
	46%,47%{opacity:1;;-webkit-transform:translateY(0);;transform:translateY(0)}
}
@keyframes lock-cap{
	0%,45%,48%,100%{opacity:0;-webkit-transform:translateY(-10px);transform:translateY(-10px)}
	46%,47%{opacity:1;;-webkit-transform:translateY(0);;transform:translateY(0)}
...
$(document).ready(function(){
	setTimeout(flashTo,2000)
});
    function flashTo(){
	window.location.href = "<%=basePath %>load/main.action"
    }
</script>
</html>
